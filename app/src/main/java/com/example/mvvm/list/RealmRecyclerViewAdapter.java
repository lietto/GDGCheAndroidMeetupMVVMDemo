...
public abstract class RealmRecyclerViewAdapter<T extends RealmModel, S extends RecyclerView.ViewHolder>
        ...
        return new OrderedRealmCollectionChangeListener() {
            ...
            public void onChange(Object collection, OrderedCollectionChangeSet changeSet) {
                ...
                for (int i = deletions.length - 1; i >= 0; i--) {
                    ...
                    rangeRemoved(range.startIndex, range.length);
                }

                OrderedCollectionChangeSet.Range[] insertions = changeSet.getInsertionRanges();
                for (OrderedCollectionChangeSet.Range range : insertions) {
                    rangeInserted(range.startIndex, range.length);
                }
                ...
                for (OrderedCollectionChangeSet.Range range : modifications) {
                    rangeChanged(range.startIndex, range.length);
                }
            }
        };
    }
    ...
    protected void rangeInserted(int startIndex, int length) {
